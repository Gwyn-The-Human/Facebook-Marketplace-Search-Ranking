...
final_size = 128 #the final shape of proccessed images will be [final_size, final_size]
...
def resize_image(final_size, im): #is currently called in fb_dataset module in get_item to resize images on the go
    """
